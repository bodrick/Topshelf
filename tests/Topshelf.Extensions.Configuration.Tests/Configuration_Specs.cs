    ...
    public class Passing_install
    {
        ...
        public void Should_create_a_service_that_has_start_timeout()
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:StartTimeout", "123" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:Account", "LocalService" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:Account", "LocalSystem" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:Account", "NetworkService" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:StartMode", "Disabled" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:StartMode", "auto" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:StartMode", "Delayed" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:StartMode", "Manual" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:Description", "Joe is good" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:DisplayName", "Joe" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:DisplayName", "Joe" }, { "topshelf:Instance", "42" }, })
                .Build()
                .GetSection("topshelf");
        ...
        public void Should_create_an_install_host_with_display_name_with_instance_name()
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string>
                {
                    { "topshelf:DisplayName", "Joe (Instance: 42)" }, { "topshelf:Instance", "42" },
                })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:ServiceName", "Joe" }, })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:ServiceName", "Joe" }, { "topshelf:Instance", "42" }, })
                .Build()
                .GetSection("topshelf");
        ...
        public void Should_create_and_install_host_with_service_name_containing_space()
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string>
                {
                    { "topshelf:ServiceName", "Joe's Service" }, { "topshelf:Instance", "42" },
                })
                .Build()
                .GetSection("topshelf");
        ...
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string> { { "topshelf:Account:Username", "Joe" }, })
                .Build()
                .GetSection("topshelf");
        ...
        public void Will_allow_blank_password_when_specifying_username()
        {
            var configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new Dictionary<string, string>
                {
                    { "topshelf:Account:Username", "Joe" }, { "topshelf:Account:Password", "" },
                })
                .Build()
                .GetSection("topshelf");
        ...
        private class MyHostConfigurator : IHostConfigurator
        {
            public IHostBuilderConfigurator Configuratior { get; private set; }

            public UnhandledExceptionPolicyCode UnhandledExceptionPolicy => throw new NotImplementedException();

            UnhandledExceptionPolicyCode IHostConfigurator.UnhandledExceptionPolicy
            {
