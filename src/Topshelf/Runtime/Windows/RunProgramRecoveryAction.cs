...
namespace Topshelf.Runtime.Windows
{
    ...
    public class RunProgramRecoveryAction : ServiceRecoveryAction
    {
        /// <summary>
        ...
        public RunProgramRecoveryAction(System.TimeSpan delay, string command) : base(delay) => Command = command;
