...
namespace Topshelf.Runtime
{
    ...
    public interface IHostEnvironment
    {
        ...
        void InstallService(IInstallHostSettings settings, Action<IInstallHostSettings> beforeInstall, Action afterInstall, Action beforeRollback, Action afterRollback);
        ...
        /// </summary>
        /// <param name="serviceName">The name of the service</param>
        /// <param name="stopTimeOut">Waits for the service to reach the stopped status in the specified time.</param>
