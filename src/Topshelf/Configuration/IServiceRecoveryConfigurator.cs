...
namespace Topshelf.Configuration
{
    ...
    /// </summary>
    public interface IServiceRecoveryConfigurator
    {
        /// <summary>
        ...
        IServiceRecoveryConfigurator RestartComputer(System.TimeSpan delay, string message);
        ...
        /// <param name="message"> </param>
        /// <returns>The service recovery configurator.</returns>
        IServiceRecoveryConfigurator RestartComputer(int delayInMinutes, string message);
        ...
        /// <param name="delay">The delay.</param>
        /// <returns>The service recovery configurator.</returns>
        IServiceRecoveryConfigurator RestartService(System.TimeSpan delay);
        ...
        /// <param name="delayInMinutes">The delay in minutes.</param>
        /// <returns>The service recovery configurator.</returns>
        IServiceRecoveryConfigurator RestartService(int delayInMinutes);
        ...
        /// <returns>The service recovery configurator.</returns>
        IServiceRecoveryConfigurator RunProgram(System.TimeSpan delay, string command);
        ...
        /// <param name="command">The command to run.</param>
        /// <returns>The service recovery configurator.</returns>
        IServiceRecoveryConfigurator RunProgram(int delayInMinutes, string command);

        /// <summary>
        ///   Specifies the reset period for the restart options
        /// </summary>
        /// <param name="days">The reset period in days.</param>
        IServiceRecoveryConfigurator SetResetPeriod(int days);

        /// <summary>
        ///   Take no action
        /// </summary>
        /// <returns>The service recovery configurator.</returns>
        IServiceRecoveryConfigurator TakeNoAction();
    }
}
