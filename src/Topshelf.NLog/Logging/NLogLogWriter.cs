...
namespace Topshelf.Logging
{
    ...
    public class NLogLogWriter : ILogWriter
    {
        ...
        public void Debug(object obj) => _log.Log(LogLevel.Debug, obj);

        public void Debug(object obj, Exception exception) => _log.Log(LogLevel.Debug, exception, obj.ToString());
        ...
        public void DebugFormat(string format, params object[] args) => _log.Log(LogLevel.Debug, format, args);

        public void Error(object obj) => _log.Log(LogLevel.Error, obj);

        public void Error(object obj, Exception exception) => _log.Log(LogLevel.Error, exception, obj.ToString());
        ...
        public void ErrorFormat(string format, params object[] args) => _log.Log(LogLevel.Error, format, args);

        public void Fatal(object obj) => _log.Log(LogLevel.Fatal, obj);

        public void Fatal(object obj, Exception exception) => _log.Log(LogLevel.Fatal, exception, obj.ToString());
        ...
        public void FatalFormat(string format, params object[] args) => _log.Log(LogLevel.Fatal, format, args);

        public void Info(object obj) => _log.Log(LogLevel.Info, obj);

        public void Info(object obj, Exception exception) => _log.Log(LogLevel.Info, exception, obj.ToString());
        ...
        public void InfoFormat(string format, params object[] args) => _log.Log(LogLevel.Info, format, args);

        public void Log(LoggingLevel level, object obj) => _log.Log(GetNLogLevel(level), obj);

        public void Log(LoggingLevel level, object obj, Exception exception) => _log.Log(GetNLogLevel(level), exception, obj.ToString());
        ...
        public void Warn(object obj) => _log.Log(LogLevel.Warn, obj);

        public void Warn(object obj, Exception exception) => _log.Log(LogLevel.Warn, exception, obj.ToString());
        ...
        public void WarnFormat(string format, params object[] args) => _log.Log(LogLevel.Warn, format, args);

        private static LogLevel GetNLogLevel(LoggingLevel level)
        {
