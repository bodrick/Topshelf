...
{
    public sealed class NLogLogWriterFactory : ILogWriterFactory
    {
        private readonly LogFactory _logFactory;

        private NLogLogWriterFactory(LogFactory logFactory) => _logFactory = logFactory;

        private NLogLogWriterFactory() : this(new LogFactory())
        {
        }
